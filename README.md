> **Note:** This is the development version and contains features that may be in various stages of development. If you want to use this on a live website download here: [White Label Custom Login for WordPress](https://wordpress.org/plugins/wp-white-label-login/).


# Easy White Label


### Easy White Label, Custom WordPress Login Page, Registration, and Lost Password Page
...
[Easy White Label](https://wordpress.org/plugins/wp-white-label-login/) is hosted on the offical WordPress Plugin Repository get  automatic updates with [WordPress](https://wordpress.org/plugins/wp-white-label-login/)

## Built With


	WP Easy White Label  , like WordPress, is licensed under the GPL.
	Use it to make something cool, have fun, and share.

	WP Easy White Label   is free software; you can redistribute it and/or
	...
	along with WP Easy White Label . If not, see http://www.gnu.org/licenses
