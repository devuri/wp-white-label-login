...
After you install and activate the plugin, you can go to the main settings section there will be a new settings submenu "white label login", here is where you can update the settings options.
